...
/** Model-first declaration of the BeautyQ domain graph.
  *
  * This is a thin compatibility wrapper around [[BeautyQCatalogGraph]], the
  * central BeautyQ catalog graph facade: node vals delegate to
  * [[BeautyQCatalogGraph.Nodes]] and relation vals delegate to a
  * [[BeautyQCatalogGraph.Relations]] wired from the constructor repositories.
  * The generic foundation ([[RepoEntity]], [[RepoOp]], [[EntityNode]],
  * [[Relation]], [[GraphLoading]]) knows nothing about BeautyQ and never
  * imports search classes.
  *
...
final class BeautyQRepoGraph[F[_, _]](
  ...
  val categoryTree: Relation.SelfTree[F, Category, CategoryId] = relations.categoryTree

  val categoryServices: Relation.HasMany[F, Category, CategoryId, Service, ServiceId] = relations.categoryServices

  val serviceSchemas: Relation.HasValue[F, Service, ServiceId, ServiceVariantSchema, ServiceId, ServiceVariantSchemaItem] = relations.serviceSchemas

  val allMasters: Relation.All[F, Master, MasterId] = relations.allMasters

  val masterLocationsByMaster: Relation.HasMany[F, Master, MasterId, MasterLocation, MasterLocationId] = relations.masterLocationsByMaster

  val masterOffersByMaster: Relation.HasMany[F, Master, MasterId, MasterServiceOffer, MasterServiceOfferId] = relations.masterOffersByMaster

  val offerVariants: Relation.HasMany[F, MasterServiceOffer, MasterServiceOfferId, MasterServiceOfferVariant, MasterServiceOfferVariantId] = relations.offerVariants
