  ...
  val vocabulary: SearchIntentVocabulary[SearchConstraint] =
    SearchIntentVocabulary(
      rules = List(
        ...
        alias(Set("классика", "classic", "1d", "1 д", "classic1_d"), List(enumConstraint("lash_volume", "classic1_d"), enumConstraint("lash_service_type", "extension")), requires = List(SearchConstraint.ServiceAny(Set(LashesService)))),
        alias(Set("2д", "2d", "volume2_d"), List(enumConstraint("lash_volume", "volume2_d"), enumConstraint("lash_service_type", "extension")), requires = List(SearchConstraint.ServiceAny(Set(LashesService)))),
        alias(Set("3д", "3d", "volume3_d"), List(enumConstraint("lash_volume", "volume3_d"), enumConstraint("lash_service_type", "extension")), requires = List(SearchConstraint.ServiceAny(Set(LashesService)))),
        alias(Set("mega volume"), List(enumConstraint("lash_volume", "mega_volume"), enumConstraint("lash_service_type", "extension")), requires = List(SearchConstraint.ServiceAny(Set(LashesService)))),
