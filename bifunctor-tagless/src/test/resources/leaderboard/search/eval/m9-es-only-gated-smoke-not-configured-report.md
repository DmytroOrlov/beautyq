...
- eval_dataset_id: beautyq-m9-es-only-gated-smoke-v1
...
- candidate_source: es
- routing_policy_id: m9-es-only-gated-smoke-es-v1
- fusion_policy: none
- reranker_policy: none
- experiment_id: m9-es-only-gated-smoke-spec
- metadata_catalog_snapshot_id: seed-resource-catalog
- metadata_eval_dataset_id: beautyq-m9-es-only-gated-smoke-v1
- metric_window: offline-es-smoke
...
|---|---|---|---|---|---|---|---|
| q_es_smoke_exact_001 | exact_product_name_brand | es_only | es | - | failure_count=1 | failed | gate_status=allowed_without_resource_config, backend failure: es offline adapter resource config is not configured; no real backend call attempted |
| q_es_smoke_semantic_001 | semantic_descriptive | es_only | es | - | failure_count=1 | failed | gate_status=allowed_without_resource_config, backend failure: es offline adapter resource config is not configured; no real backend call attempted |
