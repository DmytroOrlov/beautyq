...
- [x] T001 Re-derive and record the evaluated source/architecture state in `specs/004-beautyq-post-closeout-simplification-decision/decision-record.md` (section `## Evaluated State`).
...
- [x] T002 Materialize the provisional candidate inventory facts knowable before evidence and record them in `decision-record.md` (section `## Candidate Inventory (provisional)`).
...
- [x] T003 [P] [US1] Collect seam E-1 (F-QDRANT marginal product value) evidence into `target/004-scratch/e1-qdrant.md`.
...
- [x] T004 [P] [US1] Collect seams E-2 and E-3 (F-TRACE reachability; 003 `C-20` bounded search) evidence into `target/004-scratch/e2-trace.md`.
...
- [x] T005 [P] [US1] Collect seam E-4 (F-PROJECT boundary ownership) evidence into `target/004-scratch/e4-project.md`.
...
- [x] T006 [P] [US1] Collect seam E-5 (F-TEST coverage map) evidence into `target/004-scratch/e5-test.md`.
...
- [x] T007 [P] [US1] Collect seam E-6 (F-DOCS + F-AUDIT-DISC docs/discoverability) evidence into `target/004-scratch/e6-docs-auditdisc.md`.
...
- [x] T008 [US1] Resolve bounded evidence seams and admit/split/merge/reject provisional units to produce the final decision units in `decision-record.md` (sections `## Candidate Inventory (derivation)` and `## Candidates`).
...
- [x] T009 [US1] Assess every final Candidate across all twelve dimensions **and** assign its single disposition in `decision-record.md`.
...
- [x] T010 [US1] Apply the change-oriented obligation/break/unowned gate for every non-`KEEP`/non-`INSUFFICIENT_EVIDENCE` disposition in `decision-record.md`.
...
- [x] T011 [US2] Write the synthesis in `decision-record.md` (section `## Synthesis`).
...
- [x] T012 [US2] Finalize the canonical decision record as the single serialized final content writer of `specs/004-beautyq-post-closeout-simplification-decision/decision-record.md`.
...
- [x] T013 Validate the complete decision package and stop condition; append one compact `## Validation` section to `decision-record.md`.
