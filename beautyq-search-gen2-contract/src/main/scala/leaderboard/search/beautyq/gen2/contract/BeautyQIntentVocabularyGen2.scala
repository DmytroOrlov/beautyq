...
object BeautyQIntentVocabulary {
  ...
  private val sourceRules: Vector[BeautyIntentRule] = Vector(
    ...
    rule("r005", "наращивание и моделирование ногтей", "наращивание ногтей", "acrylic nails", "nagelmodellage", "künstliche nägel", "artificial nails", "nail extension", "builder gel")(service("nail_modeling"), enumAttr("nail_service_type", "extension")),
    ...
    rule("r078", "upper lip", "верхняя губа", "lip")(enumAttr("body_area", "upper_lip"))(using mode = IntentRuleMode.Contextual, requires = Vector(service("hair_removal"))),
