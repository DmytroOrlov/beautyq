...
object BeautyQIntentVocabulary {
  ...
  private val sourceRules: Vector[BeautyIntentRule] = Vector(
    ...
    rule("r004", "педикюр", "pedicure", "fußpflege")(service("pedicure"), enumAttr("nail_service_type", "pedicure")),
    ...
    rule("r021", "гель лак", "gel polish")(enumAttr("nail_coating_type", "gel_polish")),
    ...
    rule("r041", "lash lifting")(enumAttr("lash_service_type", "lifting"), service("lashes")),
    ...
    rule("r053", "färben", "tint", "окрашивание")(bool("with_tinting", true))(using mode = IntentRuleMode.Contextual, requires = Vector(service("brows"))),
    rule("r054", "färben", "tint", "окрашивание")(bool("with_tinting", true))(using mode = IntentRuleMode.Contextual, requires = Vector(service("lashes"))),
    ...
    rule("r070", "wax", "воск", "воском")(service("hair_removal"), enumAttr("hair_removal_method", "wax")),
    ...
    rule("r078", "upper lip", "верхняя губа")(enumAttr("body_area", "upper_lip"))(using mode = IntentRuleMode.Contextual, requires = Vector(service("hair_removal"))),
    ...
    rule("r082", "armpits")(enumAttr("body_area", "armpits"))(using mode = IntentRuleMode.Contextual, requires = Vector(service("hair_removal"))),
