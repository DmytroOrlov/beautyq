...
- Standalone ES lifecycle-gate design/source-confirmation docs were removed once `BeautySearchServingGate` (M14B) and the `GET /ops/beauty-search/lifecycle` endpoint shipped. Current truth for both is in `docs/BEAUTYQ_CURRENT_STATE_AND_HANDOFF.md` sections 1-2.
