...
Any later hybrid implementation should wait for the shared M8/M9 telemetry and offline-eval vocabulary defined in `docs/local/M8_M9_TELEMETRY_AND_OFFLINE_EVAL_PLAN.md`.
