...
* Recommended next large chunk: source-confirm a disabled-by-default Qdrant opt-in config-gate model and its pending module contract, without route wiring.
* `seedCatalogInMemory` remains available as rollback/non-default.
