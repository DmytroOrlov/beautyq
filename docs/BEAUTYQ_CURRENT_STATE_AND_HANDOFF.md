...
* Future real ES/Qdrant offline adapters are planned only as offline M9 seams feeding the existing saved-report path; they are not implemented and do not activate production serving.
