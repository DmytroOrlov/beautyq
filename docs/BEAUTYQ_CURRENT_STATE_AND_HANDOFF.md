...
* The future M9 backend-runner execution seam is documented as planning only in `docs/local/M8_M9_TELEMETRY_AND_OFFLINE_EVAL_PLAN.md`; it is not implemented and does not approve any production route or activation change.
