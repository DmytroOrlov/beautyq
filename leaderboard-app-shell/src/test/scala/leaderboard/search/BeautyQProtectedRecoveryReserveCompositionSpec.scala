...
final class BeautyQProtectedRecoveryReserveCompositionSpec extends AnyWordSpec {
  ...
  "BeautyQProtectedRecoveryReserveComposition" should {
    ...
    "load recovery through the eval owner from app-shell classpath" in {
      assert(composition.recovery.authorReserve.schemaVersion == "beautyq-protected-recovery-author-reserve-v7")
      assert(composition.recovery.judgedReserve.schemaVersion == "beautyq-protected-recovery-judged-reserve-v7")
      assert(composition.recovery.selectionAudit.schemaVersion == "beautyq-protected-recovery-selection-audit-v9")
      assert(composition.recovery.authorReserve.authorPassId == "q2i8-recovery-rotation-8-fresh-reserve-author-v1")
      assert(composition.recovery.judgedReserve.judgePassId == "q2i8-recovery-rotation-8-fresh-reserve-judge-v1")
      assert(composition.recovery.selectionAudit.auditPassId == "q2i8-recovery-rotation-8-fresh-reserve-selection-audit-v1")
