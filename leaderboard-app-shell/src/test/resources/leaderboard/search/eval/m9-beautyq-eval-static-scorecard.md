...
| metric | value |
|---|---|
| dataset_query_count | 89 |
| mapped_row_count | 89 |
| static_runner_accepted_row_count | 89 |
| representative_anchor_row_count | 3 |
| placeholder_only_row_count | 86 |
...
| full_74_query_static_expansion_implemented | true |
...
- Full JSON parsing remains intentionally deferred; the 74-query static-row expansion is implemented.
