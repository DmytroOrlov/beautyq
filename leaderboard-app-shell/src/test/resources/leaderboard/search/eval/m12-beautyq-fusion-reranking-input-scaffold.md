...
- fusion_reranking_input_rows: 89
- fusion_reranking_backend_candidate_rows: 88
- fusion_reranking_executable_rows: 0
- real_candidate_result_rows: 0
- pending_not_executed_result_leg_rows: 160
- combined_comparison_pair_placeholders: 72
...
| combined_comparison_placeholder_input | 72 |
...
| metric | value |
|---|---|
| es_pending_result_leg_placeholder_rows | 87 |
| qdrant_pending_result_leg_placeholder_rows | 73 |
| pending_not_executed_result_leg_rows | 160 |
| combined_comparison_pair_placeholders | 72 |
...
| consumed_matrix_denied_row_count | 12 |
| consumed_matrix_skipped_row_count | 0 |
| input_group_count_sum | 89 |
| es_only_placeholder_input_rows | 15 |
| qdrant_only_placeholder_input_rows | 1 |
| combined_comparison_placeholder_input_rows | 72 |
