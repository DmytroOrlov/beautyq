...
object BeautyQProtectedRecoveryReserve {
  ...
  private val CurrentAuthorSchema = "beautyq-protected-recovery-author-reserve-v5"

  private val JudgedReserveRootFields = Set("schemaVersion", "sourceRevision", "judgePassId", "corpus")
  private val CurrentJudgedSchema = "beautyq-protected-recovery-judged-reserve-v5"
  ...
  private val CurrentAuditSchema = "beautyq-protected-recovery-selection-audit-v7"
